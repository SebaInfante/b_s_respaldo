...
const getEmployment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const employment = yield Employment_1.default.findAll({ where: { employee: empresa } });
...
const getFichaPerson = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const Employee = (yield ((_e = Pass_Record_1.default.sequelize) === null || _e === void 0 ? void 0 : _e.query(`
              ...
              `, { type: QueryTypes.SELECT }))) || "";
        const Documents = (yield ((_f = Pass_Record_1.default.sequelize) === null || _f === void 0 ? void 0 : _f.query(`
        ...
        const resultado = yield (0, pdfkit_1.generarPDF)(data);
        // console.log(resultado);
        // let url = path.join(__dirname, "..", "reports", resultado?.Filename);
        res.status(200).json(resultado === null || resultado === void 0 ? void 0 : resultado.Filename);
    }
    catch (error) {
        console.log(error);
    }
...
const downloadFicha = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let url = path_1.default.join(__dirname, "..", "reports", filename);
...
const getPerson = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _g, _h, _j;
    const rut = req.params.rut;
    const Person = (yield ((_g = Pass_Record_1.default.sequelize) === null || _g === void 0 ? void 0 : _g.query(`
              ...
              `, { type: QueryTypes.SELECT }))) || "";
    const person_id = Person[0].id;
    const Employee = (yield ((_h = Pass_Record_1.default.sequelize) === null || _h === void 0 ? void 0 : _h.query(`
              ...
              WHERE 
                  ( ${person_id} = employee.person_id AND 
                    ...
                    employee.deleted_flag = 0)
              `, { type: QueryTypes.SELECT }))) || "";
    const Documents = (yield ((_j = Pass_Record_1.default.sequelize) === null || _j === void 0 ? void 0 : _j.query(`
              SELECT docfile.name AS docName , docfile.resource_url AS docURL, docfile.resource_alias AS docAlias, docfile.id_document AS id
              FROM  tdx_docfile AS docfile
              WHERE docfile.id_person = '${person_id}'
...
const getDocumentsPerson = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const Document = (yield ((_k = Pass_Record_1.default.sequelize) === null || _k === void 0 ? void 0 : _k.query(`
            SELECT docfile.*
            FROM  tdx_docfile AS docfile
...
const cantPersonasTotales = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _m;
    const resource = (yield ((_m = Pass_Record_1.default.sequelize) === null || _m === void 0 ? void 0 : _m.query(`
...
const photoFile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const resource_alias = (_o = req.file) === null || _o === void 0 ? void 0 : _o.originalname;
        const resource_size = Math.trunc(resizedImageBuffer.byteLength / 1000);
        const resource_dimensions = "700*700";
        const suffix = ".png";
        const resource = (yield ((_p = Resource_Data_1.default.sequelize) === null || _p === void 0 ? void 0 : _p.query(`
...
const docsFile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (req.file) {
            ...
            const resource_url = `uploads/${(_q = req.file) === null || _q === void 0 ? void 0 : _q.filename}`;
            const resource_alias = (_r = req.file) === null || _r === void 0 ? void 0 : _r.originalname;
            const resource_size = (_s = req.file) === null || _s === void 0 ? void 0 : _s.size;
...
const addPerson = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userAuth = req.body.userAuth;
    const rut = req.body.rut;
    const rutValidator = yield Person_1.default.findOne({
    ...
    if (rutValidator) {
        ...
        const resource = (yield ((_u = Resource_Data_1.default.sequelize) === null || _u === void 0 ? void 0 : _u.query(`
        ...
        const resource = (yield ((_v = Resource_Data_1.default.sequelize) === null || _v === void 0 ? void 0 : _v.query(`
...
const addEmplyee = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const empresaEncontrada = yield Employee_Group_1.default.findOne({
        where: { name: empresa },
    });
    const resource = (yield ((_w = Resource_Data_1.default.sequelize) === null || _w === void 0 ? void 0 : _w.query(`
...
const addPersonPhoto = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const resource = (yield ((_x = Resource_Data_1.default.sequelize) === null || _x === void 0 ? void 0 : _x.query(`
...
const deletePerson = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const fecha = new Date();
        const today = `${fecha.getFullYear()}-${fecha.getMonth() + 1}-${fecha.getDate()} ${fecha.getHours()}:${fecha.getMinutes()}:${fecha.getSeconds()}`;
        const resourceEmployee = (yield ((_y = Resource_Data_1.default.sequelize) === null || _y === void 0 ? void 0 : _y.query(`
            UPDATE tdx_employee SET deleted_flag = 1, update_time = '${today}', update_user = '${userAuth.name}' WHERE person_id = '${ID}'
                    `))) || "";
        const resourcePerson = (yield ((_z = Resource_Data_1.default.sequelize) === null || _z === void 0 ? void 0 : _z.query(`
            UPDATE tdx_person SET deleted_flag = 1,expire_time = '${today}', update_time = '${today}', update_user = '${userAuth.name}' WHERE id = '${ID}'
                    `))) || "";
        const resourcePersonPhoto = (yield ((_0 = Resource_Data_1.default.sequelize) === null || _0 === void 0 ? void 0 : _0.query(`
            UPDATE tdx_person_photo SET deleted_flag = 1, update_time = '${today}', update_user = '${userAuth.name}' WHERE person_id = '${ID}'
                    `))) || "";
        const resourcedocFile = (yield ((_1 = Resource_Data_1.default.sequelize) === null || _1 === void 0 ? void 0 : _1.query(`
...
const deleteFile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const fecha = new Date();
    const today = `${fecha.getFullYear()}-${fecha.getMonth() + 1}-${fecha.getDate()} ${fecha.getHours()}:${fecha.getMinutes()}:${fecha.getSeconds()}`;
    const resourceDoc = (yield ((_2 = Resource_Data_1.default.sequelize) === null || _2 === void 0 ? void 0 : _2.query(`
...
const sendEmailDeletePerson = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log("hola");
    const rut = req.body.rut;
    const Mandante = (yield ((_3 = Pass_Record_1.default.sequelize) === null || _3 === void 0 ? void 0 : _3.query(`
                ...
                WHERE 
                    ...
                    `, { type: QueryTypes.SELECT }))) || "";
    const Empresa = (yield ((_4 = Pass_Record_1.default.sequelize) === null || _4 === void 0 ? void 0 : _4.query(`
...
const downloadReportRecords = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const resource = yield ((_5 = Pass_Record_1.default.sequelize) === null || _5 === void 0 ? void 0 : _5.query(`
              SELECT DISTINCT  person.id AS id, data.resource_url ,employee.email AS email, person.name ,  person.id_card , egroup.name AS empresa , person.create_time , employment.employment AS ocupacion
              FROM  (SELECT * FROM tdx_person WHERE deleted_flag = 0) AS person, (SELECT * FROM tdx_person_photo WHERE deleted_flag = 0)  AS photo, tdx_resource_data AS data, tdx_employee_group AS egroup, (SELECT * FROM tdx_employee WHERE deleted_flag = 0) AS employee, tdx_employment AS employment
              WHERE 
                  (person.id = photo.person_id AND 
